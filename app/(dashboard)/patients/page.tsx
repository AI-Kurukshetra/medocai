  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">Patient registry for your organization</p>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-100">
              ...
              <th className="text-left p-4 text-xs font-semibold text-slate-500 uppercase tracking-wide">MRN</th>
              <th className="text-left p-4 text-xs font-semibold text-slate-500 uppercase tracking-wide">DOB</th>
              <th className="text-left p-4 text-xs font-semibold text-slate-500 uppercase tracking-wide">Gender</th>
              <th className="text-left p-4 text-xs font-semibold text-slate-500 uppercase tracking-wide">Insurance</th>
            </tr>
          </thead>
          <tbody>
